...
COPY . /var/www/html
COPY --from=gcr.io/yescloud/anim ./.env /var/www/html
COPY --from=gcr.io/yescloud/anim ./.htaccess /var/www/html/public
COPY --from=gcr.io/yescloud/anim ./jwt/ /var/www/html/config/jwt
